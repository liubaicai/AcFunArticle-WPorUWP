...
namespace ACWZ
{
    public partial class DetailPage : PhoneApplicationPage, INotifyPropertyChanged
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            try
            {
                if (e.NavigationMode == NavigationMode.New)
                {
                    ...
                    using (var stream = await new HttpHelp().Get("http://www.acfun.com" + StaticData.acitem.href))
                    {
                        ...
                        try
                        {
                            ...
                            if (node != null)
                            {
                                foreach (var item in node.ChildNodes[2].ChildNodes)
                                {
                                    if (item.Name.Equals("div") && item.HasAttributes && item.Id.Equals("area-player"))
                                    {
                                        list.Clear();
                                        ...
                                        if (list.Count == 0)
                                        {
                                            ...
                                            browser.NavigateToString(item.InnerHtml);
                        ...
                        foreach (var body in html.ChildNodes)
                        {
                            if (body.Name.Equals("body"))
                            {
                                foreach (var div1 in body.ChildNodes)
                                {
                                    ...
                                    {
                                        if (div1.HasAttributes && div1.Attributes.Count > 1 && div1.Attributes[0].Value.Equals("mainer") && div1.Attributes[1].Value.Equals("article article-article"))
                                        {
                                            return div1;
                                        }
                                        if (div1.HasChildNodes)
                                        {
                                            ...
                                            {
                                                if (div2.HasAttributes && div2.Attributes.Count > 1 && div2.Attributes[0].Value.Equals("mainer") && div2.Attributes[1].Value.Equals("article article-article"))
                                                {
                                                    return div2;
                                                }
                                                if (div2.HasChildNodes)
                                                {
                                                    ...
                                                    {
                                                        if (div3.HasAttributes && div3.Attributes.Count > 1 && div3.Attributes[0].Value.Equals("mainer") && div3.Attributes[1].Value.Equals("article article-article"))
                                                        {
                                                            return div3;
                                                        }
                                                        if (div3.HasChildNodes)
                                                        {
                                                            ...
                                                            {
                                                                if (div4.HasAttributes && div4.Attributes.Count > 1 && div4.Attributes[0].Value.Equals("mainer") && div4.Attributes[1].Value.Equals("article article-article"))
                                                                {
                                                                    return div4;
                                                                }
                                                                if (div4.HasChildNodes)
                                                                {
                                                                    ...
                                                                    {
                                                                        if (div5.HasAttributes && div5.Attributes.Count > 1 && div5.Attributes[0].Value.Equals("mainer") && div5.Attributes[1].Value.Equals("article article-article"))
                                                                        {
                                                                            return div5;
                                                                        }
                                                                        if (div5.HasChildNodes)
                                                                        {
                                                                            ...
                                                                            {
                                                                                if (div6.HasAttributes && div6.Attributes.Count > 1 && div6.Attributes[0].Value.Equals("mainer") && div6.Attributes[1].Value.Equals("article article-article"))
                                                                                {
                                                                                    return div6;
                                                                                }
                                                                            }
        ...
        private void go_Click(object sender, EventArgs e)
        {
            ...
            task.Uri = new Uri("http://www.acfun.com" + StaticData.acitem.href);
            task.Show();
        }
