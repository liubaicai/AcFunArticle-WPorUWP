        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.NavigationMode == NavigationMode.New)
            {
                try
                {
                    ...
                    //        if (version != null && version != "" && Int32.Parse(version) > App.AppVersionCount)
                    //        {
                        ...
                        foreach (var body in html.ChildNodes)
                        {
                            if (body.Name.Equals("body"))
                            {
                                foreach (var div1 in body.ChildNodes)
                                {
                                    ...
                                    {
                                        foreach (var bode1 in div1.ChildNodes)
                                        {
                                            if (bode1.HasAttributes && bode1.Attributes[0].Value.Equals("mainer"))
                                            {
                                                foreach (var bode2 in bode1.ChildNodes)
                                                {
                                                    if (bode2.Name.Equals("div"))
                                                    {
                                                        foreach (var div2 in bode2.ChildNodes)
                                                        {
                                                            if (div2.HasAttributes && div2.Attributes[0].Value.Equals("mainer"))
                                                            {
                                                                return div2;
                                                            }
                                                            if (div2.HasChildNodes)
                                                            {
                                                                ...
                                                                {
                                                                    if (div3.HasAttributes && div3.Attributes[0].Value.Equals("mainer"))
                                                                    {
                                                                        return div3;
                                                                    }
                                                                    if (div3.HasChildNodes)
                                                                    {
                                                                        ...
                                                                        {
                                                                            if (div4.HasAttributes && div4.Attributes[0].Value.Equals("mainer"))
                                                                            {
                                                                                return div4;
                                                                            }
                                                                            if (div4.HasChildNodes)
                                                                            {
                                                                                ...
                                                                                {
                                                                                    if (div5.HasAttributes && div5.Attributes[0].Value.Equals("mainer"))
                                                                                    {
                                                                                        return div5;
                                                                                    }
                                                                                    if (div5.HasChildNodes)
                                                                                    {
                                                                                        ...
                                                                                        {
                                                                                            if (div6.HasAttributes && div6.Attributes[0].Value.Equals("mainer"))
                                                                                            {
                                                                                                return div6;
                                                                                            }
                                                                                        }
