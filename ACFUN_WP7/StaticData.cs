...
namespace ACFUN
{
    public static class StaticData
    {
        ...
        public static string list1 = "http://www.acfun.tv/v/list63/index_{0}.htm";
        public static string list2 = "http://www.acfun.tv/v/list73/index_{0}.htm";
        public static string list3 = "http://www.acfun.tv/v/list74/index_{0}.htm";

        public static string login = "http://www.acfun.tv/login.aspx";
