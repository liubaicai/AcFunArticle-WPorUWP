...
namespace ACFUN
{
    ...
    {
        public static string UmengKey = "5222ee2056240b310b086cd6";
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            UmengSDK.UmengAnalytics.onLaunching(UmengKey);
        }
        ...
        {
            UmengSDK.UmengAnalytics.onActivated(UmengKey);
    ...
    class AssociationUriMapper : UriMapperBase
    {
        ...
        public override Uri MapUri(Uri uri)
        {
            ...
            if (tempUri.Contains("acfunwz:main"))
            {
